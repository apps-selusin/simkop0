...
$trekening3_edit = NULL; // Initialize page object first

class ctrekening3_edit extends ctrekening3 {
	...
	// Page object name
	var $PageObjName = 'trekening3_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("trekening3list.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($trekening3_edit)) $trekening3_edit = new ctrekening3_edit();

// Page init
$trekening3_edit->Page_Init();

// Page main
$trekening3_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$trekening3_edit->Page_Render();
?>
...
var CurrentForm = ftrekening3edit = new ew_Form("ftrekening3edit", "edit");

// Validate form
ftrekening3edit.Validate = function() {
...
ftrekening3edit.Form_CustomValidate = 
...
ftrekening3edit.ValidateRequired = true;
<?php } else { ?>
ftrekening3edit.ValidateRequired = false; 
<?php } ?>
...
ftrekening3edit.Lists["x_status[]"].Options = <?php echo json_encode($trekening3->status->Options()) ?>;
...
<?php if (!$trekening3_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $trekening3_edit->ShowPageHeader(); ?>
<?php
$trekening3_edit->ShowMessage();
?>
<form name="ftrekening3edit" id="ftrekening3edit" class="<?php echo $trekening3_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($trekening3_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $trekening3_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $trekening3->group->EditValue ?></p></span>
</span>
<input type="hidden" data-table="trekening3" data-field="x_group" name="x_group" id="x_group" value="<?php echo ew_HtmlEncode($trekening3->group->CurrentValue) ?>">
...
<input type="hidden" data-table="trekening3" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($trekening3->id->CurrentValue) ?>">
<?php if (!$trekening3_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $trekening3_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ftrekening3edit.Init();
</script>
<?php
$trekening3_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$trekening3_edit->Page_Terminate();
?>
