...
//
// Table class for trekening3
//
class ctrekening3 extends cTable {
	var $group;
	var $id;
	var $id1;
	var $id2;
	...
	function __construct() {
		...
		$this->TableVar = 'trekening3';
		$this->TableName = 'trekening3';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`trekening3`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// group
		$this->group = new cField('trekening3', 'trekening3', 'x_group', 'group', '`group`', '`group`', 20, -1, FALSE, '`group`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// id
		$this->id = new cField('trekening3', 'trekening3', 'x_id', 'id', '`id`', '`id`', 200, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id->Sortable = TRUE; // Allow sort
		$this->fields['id'] = &$this->id;

		// id1
		$this->id1 = new cField('trekening3', 'trekening3', 'x_id1', 'id1', 'case when length(parent) = 1 then id else \'\' end', 'case when length(parent) = 1 then id else \'\' end', 200, -1, FALSE, 'case when length(parent) = 1 then id else \'\' end', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id1->FldIsCustom = TRUE; // Custom field
		$this->id1->Sortable = TRUE; // Allow sort
		$this->fields['id1'] = &$this->id1;

		// id2
		$this->id2 = new cField('trekening3', 'trekening3', 'x_id2', 'id2', 'case when length(parent) > 1 then id else \'\' end', 'case when length(parent) > 1 then id else \'\' end', 200, -1, FALSE, 'case when length(parent) > 1 then id else \'\' end', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id2->FldIsCustom = TRUE; // Custom field
		$this->id2->Sortable = TRUE; // Allow sort
		$this->fields['id2'] = &$this->id2;

		// parent
		$this->parent = new cField('trekening3', 'trekening3', 'x_parent', 'parent', '`parent`', '`parent`', 200, -1, FALSE, '`parent`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// id3
		$this->id3 = new cField('trekening3', 'trekening3', 'x_id3', 'id3', 'id', 'id', 200, -1, FALSE, 'id', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id3->FldIsCustom = TRUE; // Custom field
		$this->id3->Sortable = TRUE; // Allow sort
		$this->fields['id3'] = &$this->id3;

		// rekening
		$this->rekening = new cField('trekening3', 'trekening3', 'x_rekening', 'rekening', '`rekening`', '`rekening`', 200, -1, FALSE, '`rekening`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rekening->Sortable = TRUE; // Allow sort
		$this->fields['rekening'] = &$this->rekening;

		// posisi
		$this->posisi = new cField('trekening3', 'trekening3', 'x_posisi', 'posisi', '`posisi`', '`posisi`', 200, -1, FALSE, '`posisi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->posisi->Sortable = TRUE; // Allow sort
		$this->fields['posisi'] = &$this->posisi;

		// laporan
		$this->laporan = new cField('trekening3', 'trekening3', 'x_laporan', 'laporan', '`laporan`', '`laporan`', 200, -1, FALSE, '`laporan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->laporan->Sortable = TRUE; // Allow sort
		$this->fields['laporan'] = &$this->laporan;

		// keterangan
		$this->keterangan = new cField('trekening3', 'trekening3', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// tipe
		$this->tipe = new cField('trekening3', 'trekening3', 'x_tipe', 'tipe', '`tipe`', '`tipe`', 200, -1, FALSE, '`tipe`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->tipe->Sortable = TRUE; // Allow sort
		$this->tipe->OptionCount = 2;
		$this->fields['tipe'] = &$this->tipe;

		// status
		$this->status = new cField('trekening3', 'trekening3', 'x_status', 'status', '`status`', '`status`', 200, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->OptionCount = 1;
		$this->fields['status'] = &$this->status;

		// active
		$this->active = new cField('trekening3', 'trekening3', 'x_active', 'active', '`active`', '`active`', 202, -1, FALSE, '`active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`trekening3`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("trekening3view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("trekening3view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "trekening3add.php?" . $this->UrlParm($parm);
		else
			$url = "trekening3add.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("trekening3edit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("trekening3add.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("trekening3delete.php", $this->UrlParm());
	}
