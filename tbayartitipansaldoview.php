...
$tbayartitipansaldo_view = NULL; // Initialize page object first

class ctbayartitipansaldo_view extends ctbayartitipansaldo {
	...
	// Page object name
	var $PageObjName = 'tbayartitipansaldo_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "tbayartitipansaldolist.php"; // Return to list
			}
			if (@$_GET["nomor"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbayartitipansaldolist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "tbayartitipansaldolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tbayartitipansaldo_view)) $tbayartitipansaldo_view = new ctbayartitipansaldo_view();

// Page init
$tbayartitipansaldo_view->Page_Init();

// Page main
$tbayartitipansaldo_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbayartitipansaldo_view->Page_Render();
?>
...
var CurrentForm = ftbayartitipansaldoview = new ew_Form("ftbayartitipansaldoview", "view");

// Form_CustomValidate event
ftbayartitipansaldoview.Form_CustomValidate = 
...
ftbayartitipansaldoview.ValidateRequired = true;
<?php } else { ?>
ftbayartitipansaldoview.ValidateRequired = false; 
<?php } ?>
...
<div class="ewToolbar">
<?php if (!$tbayartitipansaldo_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $tbayartitipansaldo_view->ExportOptions->Render("body") ?>
<?php
	foreach ($tbayartitipansaldo_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$tbayartitipansaldo_view->IsModal) { ?>
...
<?php $tbayartitipansaldo_view->ShowPageHeader(); ?>
<?php
$tbayartitipansaldo_view->ShowMessage();
?>
<form name="ftbayartitipansaldoview" id="ftbayartitipansaldoview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tbayartitipansaldo_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tbayartitipansaldo_view->Token ?>">
<?php } ?>
...
<?php if ($tbayartitipansaldo->tanggal->Visible) { // tanggal ?>
	<tr id="r_tanggal">
		<td><span id="elh_tbayartitipansaldo_tanggal"><?php echo $tbayartitipansaldo->tanggal->FldCaption() ?></span></td>
...
<?php echo $tbayartitipansaldo->tanggal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbayartitipansaldo->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_tbayartitipansaldo_id"><?php echo $tbayartitipansaldo->id->FldCaption() ?></span></td>
...
<?php echo $tbayartitipansaldo->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbayartitipansaldo->nomor->Visible) { // nomor ?>
	<tr id="r_nomor">
		<td><span id="elh_tbayartitipansaldo_nomor"><?php echo $tbayartitipansaldo->nomor->FldCaption() ?></span></td>
...
<?php echo $tbayartitipansaldo->nomor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbayartitipansaldo->debet->Visible) { // debet ?>
	<tr id="r_debet">
		<td><span id="elh_tbayartitipansaldo_debet"><?php echo $tbayartitipansaldo->debet->FldCaption() ?></span></td>
...
<?php echo $tbayartitipansaldo->debet->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbayartitipansaldo->credit->Visible) { // credit ?>
	<tr id="r_credit">
		<td><span id="elh_tbayartitipansaldo_credit"><?php echo $tbayartitipansaldo->credit->FldCaption() ?></span></td>
...
<?php echo $tbayartitipansaldo->credit->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbayartitipansaldo->saldo->Visible) { // saldo ?>
	<tr id="r_saldo">
		<td><span id="elh_tbayartitipansaldo_saldo"><?php echo $tbayartitipansaldo->saldo->FldCaption() ?></span></td>
...
<?php echo $tbayartitipansaldo->saldo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbayartitipansaldoview.Init();
</script>
<?php
$tbayartitipansaldo_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbayartitipansaldo_view->Page_Terminate();
?>
