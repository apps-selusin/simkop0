...
$tlaporan_edit = NULL; // Initialize page object first

class ctlaporan_edit extends ctlaporan {
	...
	function Page_Main() {
		...
		if ($this->nomor->CurrentValue == "") {
			$this->Page_Terminate("tlaporanlist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// debet1
			$this->debet1->SetDbValueDef($rsnew, $this->debet1->CurrentValue, 0, $this->debet1->ReadOnly);

			// credit1
			$this->credit1->SetDbValueDef($rsnew, $this->credit1->CurrentValue, 0, $this->credit1->ReadOnly);

			// saldo1
			$this->saldo1->SetDbValueDef($rsnew, $this->saldo1->CurrentValue, 0, $this->saldo1->ReadOnly);

			// debet2
			$this->debet2->SetDbValueDef($rsnew, $this->debet2->CurrentValue, 0, $this->debet2->ReadOnly);

			// credit2
			$this->credit2->SetDbValueDef($rsnew, $this->credit2->CurrentValue, 0, $this->credit2->ReadOnly);

			// saldo2
			$this->saldo2->SetDbValueDef($rsnew, $this->saldo2->CurrentValue, 0, $this->saldo2->ReadOnly);

			// debet3
			$this->debet3->SetDbValueDef($rsnew, $this->debet3->CurrentValue, 0, $this->debet3->ReadOnly);

			// credit3
			$this->credit3->SetDbValueDef($rsnew, $this->credit3->CurrentValue, 0, $this->credit3->ReadOnly);

			// saldo3
			$this->saldo3->SetDbValueDef($rsnew, $this->saldo3->CurrentValue, 0, $this->saldo3->ReadOnly);

			// debet4
			$this->debet4->SetDbValueDef($rsnew, $this->debet4->CurrentValue, 0, $this->debet4->ReadOnly);

			// credit4
			$this->credit4->SetDbValueDef($rsnew, $this->credit4->CurrentValue, 0, $this->credit4->ReadOnly);

			// saldo4
			$this->saldo4->SetDbValueDef($rsnew, $this->saldo4->CurrentValue, 0, $this->saldo4->ReadOnly);

			// debet5
			$this->debet5->SetDbValueDef($rsnew, $this->debet5->CurrentValue, 0, $this->debet5->ReadOnly);

			// credit5
			$this->credit5->SetDbValueDef($rsnew, $this->credit5->CurrentValue, 0, $this->credit5->ReadOnly);

			// saldo5
			$this->saldo5->SetDbValueDef($rsnew, $this->saldo5->CurrentValue, 0, $this->saldo5->ReadOnly);

			// debet6
			$this->debet6->SetDbValueDef($rsnew, $this->debet6->CurrentValue, 0, $this->debet6->ReadOnly);

			// credit6
			$this->credit6->SetDbValueDef($rsnew, $this->credit6->CurrentValue, 0, $this->credit6->ReadOnly);

			// saldo6
			$this->saldo6->SetDbValueDef($rsnew, $this->saldo6->CurrentValue, 0, $this->saldo6->ReadOnly);

			// debet7
			$this->debet7->SetDbValueDef($rsnew, $this->debet7->CurrentValue, 0, $this->debet7->ReadOnly);

			// credit7
			$this->credit7->SetDbValueDef($rsnew, $this->credit7->CurrentValue, 0, $this->credit7->ReadOnly);

			// saldo7
			$this->saldo7->SetDbValueDef($rsnew, $this->saldo7->CurrentValue, 0, $this->saldo7->ReadOnly);

			// debet8
			$this->debet8->SetDbValueDef($rsnew, $this->debet8->CurrentValue, 0, $this->debet8->ReadOnly);

			// credit8
			$this->credit8->SetDbValueDef($rsnew, $this->credit8->CurrentValue, 0, $this->credit8->ReadOnly);

			// saldo8
			$this->saldo8->SetDbValueDef($rsnew, $this->saldo8->CurrentValue, 0, $this->saldo8->ReadOnly);

			// debet9
			$this->debet9->SetDbValueDef($rsnew, $this->debet9->CurrentValue, 0, $this->debet9->ReadOnly);

			// credit9
			$this->credit9->SetDbValueDef($rsnew, $this->credit9->CurrentValue, 0, $this->credit9->ReadOnly);

			// saldo9
			$this->saldo9->SetDbValueDef($rsnew, $this->saldo9->CurrentValue, 0, $this->saldo9->ReadOnly);

			// debet10
			$this->debet10->SetDbValueDef($rsnew, $this->debet10->CurrentValue, 0, $this->debet10->ReadOnly);

			// credit10
			$this->credit10->SetDbValueDef($rsnew, $this->credit10->CurrentValue, 0, $this->credit10->ReadOnly);

			// saldo10
			$this->saldo10->SetDbValueDef($rsnew, $this->saldo10->CurrentValue, 0, $this->saldo10->ReadOnly);

			// debet11
			$this->debet11->SetDbValueDef($rsnew, $this->debet11->CurrentValue, 0, $this->debet11->ReadOnly);

			// credit11
			$this->credit11->SetDbValueDef($rsnew, $this->credit11->CurrentValue, 0, $this->credit11->ReadOnly);

			// saldo11
			$this->saldo11->SetDbValueDef($rsnew, $this->saldo11->CurrentValue, 0, $this->saldo11->ReadOnly);

			// debet12
			$this->debet12->SetDbValueDef($rsnew, $this->debet12->CurrentValue, 0, $this->debet12->ReadOnly);

			// credit12
			$this->credit12->SetDbValueDef($rsnew, $this->credit12->CurrentValue, 0, $this->credit12->ReadOnly);

			// saldo12
			$this->saldo12->SetDbValueDef($rsnew, $this->saldo12->CurrentValue, 0, $this->saldo12->ReadOnly);
...
// Create page object
if (!isset($tlaporan_edit)) $tlaporan_edit = new ctlaporan_edit();

// Page init
$tlaporan_edit->Page_Init();

// Page main
$tlaporan_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tlaporan_edit->Page_Render();
?>
...
var CurrentForm = ftlaporanedit = new ew_Form("ftlaporanedit", "edit");

// Validate form
ftlaporanedit.Validate = function() {
...
ftlaporanedit.Form_CustomValidate = 
...
ftlaporanedit.ValidateRequired = true;
<?php } else { ?>
ftlaporanedit.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $tlaporan_edit->ShowPageHeader(); ?>
<?php
$tlaporan_edit->ShowMessage();
?>
<form name="ftlaporanedit" id="ftlaporanedit" class="<?php echo $tlaporan_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tlaporan_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tlaporan_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $tlaporan->nomor->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tlaporan" data-field="x_nomor" name="x_nomor" id="x_nomor" value="<?php echo ew_HtmlEncode($tlaporan->nomor->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tlaporan_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
