...
define("EWR_PROJECT_ID", "{e3b093f1-120d-4a26-9ac0-4e96d12c121b}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "simkop0_prj", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_simkop0", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'S1Dzfa1iAYaLnS2L', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/simkop0_prj.css", TRUE); // Project stylesheet file name
...
define("EWR_TABLE_PREFIX", "{e3b093f1-120d-4a26-9ac0-4e96d12c121b}", TRUE);
