...
$trekening_view = NULL; // Initialize page object first

class ctrekening_view extends ctrekening {
	...
	// Page object name
	var $PageObjName = 'trekening_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "trekeninglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "trekeninglist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "trekeninglist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		// "detail_vrekening"
		$item = &$option->Add("detail_vrekening");
		$body = $Language->Phrase("ViewPageDetailLink") . $Language->TablePhrase("vrekening", "TblCaption");
		...
		$links = "";
		if ($GLOBALS["vrekening_grid"] && $GLOBALS["vrekening_grid"]->DetailView) {
		...
		if ($GLOBALS["vrekening_grid"] && $GLOBALS["vrekening_grid"]->DetailEdit) {
		...
		if ($GLOBALS["vrekening_grid"] && $GLOBALS["vrekening_grid"]->DetailAdd) {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("vrekening", $DetailTblVar)) {
				...
				if ($GLOBALS["vrekening_grid"]->DetailView) {
					$GLOBALS["vrekening_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($trekening_view)) $trekening_view = new ctrekening_view();

// Page init
$trekening_view->Page_Init();

// Page main
$trekening_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$trekening_view->Page_Render();
?>
...
var CurrentForm = ftrekeningview = new ew_Form("ftrekeningview", "view");

// Form_CustomValidate event
ftrekeningview.Form_CustomValidate = 
...
ftrekeningview.ValidateRequired = true;
<?php } else { ?>
ftrekeningview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftrekeningview.Lists["x_group"] = {"LinkField":"x_group","Ajax":true,"AutoFill":false,"DisplayFields":["x_rekening","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"trekening"};
ftrekeningview.Lists["x_tipe[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftrekeningview.Lists["x_tipe[]"].Options = <?php echo json_encode($trekening->tipe->Options()) ?>;
ftrekeningview.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftrekeningview.Lists["x_active"].Options = <?php echo json_encode($trekening->active->Options()) ?>;
...
<div class="ewToolbar">
<?php if (!$trekening_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $trekening_view->ExportOptions->Render("body") ?>
<?php
	foreach ($trekening_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$trekening_view->IsModal) { ?>
...
<?php $trekening_view->ShowPageHeader(); ?>
<?php
$trekening_view->ShowMessage();
?>
<form name="ftrekeningview" id="ftrekeningview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($trekening_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $trekening_view->Token ?>">
<?php } ?>
...
<?php if ($trekening->group->Visible) { // group ?>
	<tr id="r_group">
		<td><span id="elh_trekening_group"><?php echo $trekening->group->FldCaption() ?></span></td>
...
<?php echo $trekening->group->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($trekening->rekening->Visible) { // rekening ?>
	<tr id="r_rekening">
		<td><span id="elh_trekening_rekening"><?php echo $trekening->rekening->FldCaption() ?></span></td>
...
<?php echo $trekening->rekening->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($trekening->tipe->Visible) { // tipe ?>
	<tr id="r_tipe">
		<td><span id="elh_trekening_tipe"><?php echo $trekening->tipe->FldCaption() ?></span></td>
...
<?php echo $trekening->tipe->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($trekening->posisi->Visible) { // posisi ?>
	<tr id="r_posisi">
		<td><span id="elh_trekening_posisi"><?php echo $trekening->posisi->FldCaption() ?></span></td>
...
<?php echo $trekening->posisi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($trekening->laporan->Visible) { // laporan ?>
	<tr id="r_laporan">
		<td><span id="elh_trekening_laporan"><?php echo $trekening->laporan->FldCaption() ?></span></td>
...
<?php echo $trekening->laporan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($trekening->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_trekening_status"><?php echo $trekening->status->FldCaption() ?></span></td>
...
<?php echo $trekening->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($trekening->parent->Visible) { // parent ?>
	<tr id="r_parent">
		<td><span id="elh_trekening_parent"><?php echo $trekening->parent->FldCaption() ?></span></td>
...
<?php echo $trekening->parent->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($trekening->keterangan->Visible) { // keterangan ?>
	<tr id="r_keterangan">
		<td><span id="elh_trekening_keterangan"><?php echo $trekening->keterangan->FldCaption() ?></span></td>
...
<?php echo $trekening->keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($trekening->active->Visible) { // active ?>
	<tr id="r_active">
		<td><span id="elh_trekening_active"><?php echo $trekening->active->FldCaption() ?></span></td>
...
<?php echo $trekening->active->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("vrekening", explode(",", $trekening->getCurrentDetailTable())) && $vrekening->DetailView) {
?>
