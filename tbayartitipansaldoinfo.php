...
$tbayartitipansaldo = NULL;

//
// Table class for tbayartitipansaldo
//
class ctbayartitipansaldo extends cTable {
	var $tanggal;
	var $id;
	var $nomor;
	var $debet;
	...
	function __construct() {
		...
		$this->TableVar = 'tbayartitipansaldo';
		$this->TableName = 'tbayartitipansaldo';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tbayartitipansaldo`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// tanggal
		$this->tanggal = new cField('tbayartitipansaldo', 'tbayartitipansaldo', 'x_tanggal', 'tanggal', '`tanggal`', ew_CastDateFieldForLike('`tanggal`', 0, "DB"), 135, 0, FALSE, '`tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tanggal->Sortable = TRUE; // Allow sort
		$this->tanggal->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['tanggal'] = &$this->tanggal;

		// id
		$this->id = new cField('tbayartitipansaldo', 'tbayartitipansaldo', 'x_id', 'id', '`id`', '`id`', 200, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id->Sortable = TRUE; // Allow sort
		$this->fields['id'] = &$this->id;

		// nomor
		$this->nomor = new cField('tbayartitipansaldo', 'tbayartitipansaldo', 'x_nomor', 'nomor', '`nomor`', '`nomor`', 20, -1, FALSE, '`nomor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// debet
		$this->debet = new cField('tbayartitipansaldo', 'tbayartitipansaldo', 'x_debet', 'debet', '`debet`', '`debet`', 5, -1, FALSE, '`debet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// credit
		$this->credit = new cField('tbayartitipansaldo', 'tbayartitipansaldo', 'x_credit', 'credit', '`credit`', '`credit`', 5, -1, FALSE, '`credit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// saldo
		$this->saldo = new cField('tbayartitipansaldo', 'tbayartitipansaldo', 'x_saldo', 'saldo', '`saldo`', '`saldo`', 5, -1, FALSE, '`saldo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tbayartitipansaldo`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tbayartitipansaldolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tbayartitipansaldoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tbayartitipansaldoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "tbayartitipansaldoadd.php?" . $this->UrlParm($parm);
		else
			$url = "tbayartitipansaldoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("tbayartitipansaldoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("tbayartitipansaldoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbayartitipansaldodelete.php", $this->UrlParm());
	}
