...
$tpinjamandetail__view = NULL; // Initialize page object first

class ctpinjamandetail__view extends ctpinjamandetail_ {
	...
	// Page object name
	var $PageObjName = 'tpinjamandetail__view';
	...
	function __construct() {
		...
		if (@$_GET["berjangka"] <> "") {
			$this->RecKey["berjangka"] = $_GET["berjangka"];
			$KeyUrl .= "&amp;berjangka=" . urlencode($this->RecKey["berjangka"]);
		}
		if (@$_GET["angsuran"] <> "") {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "tpinjamandetail_list.php"; // Return to list
			}
			if (@$_GET["berjangka"] <> "") {
				$this->berjangka->setQueryStringValue($_GET["berjangka"]);
				$this->RecKey["berjangka"] = $this->berjangka->QueryStringValue;
			} elseif (@$_POST["berjangka"] <> "") {
				$this->berjangka->setFormValue($_POST["berjangka"]);
				$this->RecKey["berjangka"] = $this->berjangka->FormValue;
			} else {
				$sReturnUrl = "tpinjamandetail_list.php"; // Return to list
			}
			if (@$_GET["angsuran"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tpinjamandetail_list.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "tpinjamandetail_list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tpinjamandetail__view)) $tpinjamandetail__view = new ctpinjamandetail__view();

// Page init
$tpinjamandetail__view->Page_Init();

// Page main
$tpinjamandetail__view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tpinjamandetail__view->Page_Render();
?>
...
var CurrentForm = ftpinjamandetail_view = new ew_Form("ftpinjamandetail_view", "view");

// Form_CustomValidate event
ftpinjamandetail_view.Form_CustomValidate = 
...
ftpinjamandetail_view.ValidateRequired = true;
<?php } else { ?>
ftpinjamandetail_view.ValidateRequired = false; 
<?php } ?>
...
<div class="ewToolbar">
<?php if (!$tpinjamandetail__view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $tpinjamandetail__view->ExportOptions->Render("body") ?>
<?php
	foreach ($tpinjamandetail__view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$tpinjamandetail__view->IsModal) { ?>
...
<?php $tpinjamandetail__view->ShowPageHeader(); ?>
<?php
$tpinjamandetail__view->ShowMessage();
?>
<form name="ftpinjamandetail_view" id="ftpinjamandetail_view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tpinjamandetail__view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tpinjamandetail__view->Token ?>">
<?php } ?>
...
<?php if ($tpinjamandetail_->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_tpinjamandetail__id"><?php echo $tpinjamandetail_->id->FldCaption() ?></span></td>
...
<?php echo $tpinjamandetail_->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tpinjamandetail_->berjangka->Visible) { // berjangka ?>
	<tr id="r_berjangka">
		<td><span id="elh_tpinjamandetail__berjangka"><?php echo $tpinjamandetail_->berjangka->FldCaption() ?></span></td>
...
<?php echo $tpinjamandetail_->berjangka->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tpinjamandetail_->angsuran->Visible) { // angsuran ?>
	<tr id="r_angsuran">
		<td><span id="elh_tpinjamandetail__angsuran"><?php echo $tpinjamandetail_->angsuran->FldCaption() ?></span></td>
...
<?php echo $tpinjamandetail_->angsuran->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tpinjamandetail_->angsuranpokok->Visible) { // angsuranpokok ?>
	<tr id="r_angsuranpokok">
		<td><span id="elh_tpinjamandetail__angsuranpokok"><?php echo $tpinjamandetail_->angsuranpokok->FldCaption() ?></span></td>
...
<?php echo $tpinjamandetail_->angsuranpokok->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tpinjamandetail_->angsuranpokokauto->Visible) { // angsuranpokokauto ?>
	<tr id="r_angsuranpokokauto">
		<td><span id="elh_tpinjamandetail__angsuranpokokauto"><?php echo $tpinjamandetail_->angsuranpokokauto->FldCaption() ?></span></td>
...
<?php echo $tpinjamandetail_->angsuranpokokauto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tpinjamandetail_->angsuranbunga->Visible) { // angsuranbunga ?>
	<tr id="r_angsuranbunga">
		<td><span id="elh_tpinjamandetail__angsuranbunga"><?php echo $tpinjamandetail_->angsuranbunga->FldCaption() ?></span></td>
...
<?php echo $tpinjamandetail_->angsuranbunga->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tpinjamandetail_->angsuranbungaauto->Visible) { // angsuranbungaauto ?>
	<tr id="r_angsuranbungaauto">
		<td><span id="elh_tpinjamandetail__angsuranbungaauto"><?php echo $tpinjamandetail_->angsuranbungaauto->FldCaption() ?></span></td>
...
<?php echo $tpinjamandetail_->angsuranbungaauto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tpinjamandetail_->totalangsuran->Visible) { // totalangsuran ?>
	<tr id="r_totalangsuran">
		<td><span id="elh_tpinjamandetail__totalangsuran"><?php echo $tpinjamandetail_->totalangsuran->FldCaption() ?></span></td>
...
<?php echo $tpinjamandetail_->totalangsuran->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tpinjamandetail_->totalangsuranauto->Visible) { // totalangsuranauto ?>
	<tr id="r_totalangsuranauto">
		<td><span id="elh_tpinjamandetail__totalangsuranauto"><?php echo $tpinjamandetail_->totalangsuranauto->FldCaption() ?></span></td>
...
<?php echo $tpinjamandetail_->totalangsuranauto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tpinjamandetail_->sisaangsuran->Visible) { // sisaangsuran ?>
	<tr id="r_sisaangsuran">
		<td><span id="elh_tpinjamandetail__sisaangsuran"><?php echo $tpinjamandetail_->sisaangsuran->FldCaption() ?></span></td>
...
<?php echo $tpinjamandetail_->sisaangsuran->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tpinjamandetail_->sisaangsuranauto->Visible) { // sisaangsuranauto ?>
	<tr id="r_sisaangsuranauto">
		<td><span id="elh_tpinjamandetail__sisaangsuranauto"><?php echo $tpinjamandetail_->sisaangsuranauto->FldCaption() ?></span></td>
...
<?php echo $tpinjamandetail_->sisaangsuranauto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftpinjamandetail_view.Init();
</script>
<?php
$tpinjamandetail__view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tpinjamandetail__view->Page_Terminate();
?>
