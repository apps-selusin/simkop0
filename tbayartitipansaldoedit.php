...
$tbayartitipansaldo_edit = NULL; // Initialize page object first

class ctbayartitipansaldo_edit extends ctbayartitipansaldo {
	...
	// Page object name
	var $PageObjName = 'tbayartitipansaldo_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("tbayartitipansaldolist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($tbayartitipansaldo_edit)) $tbayartitipansaldo_edit = new ctbayartitipansaldo_edit();

// Page init
$tbayartitipansaldo_edit->Page_Init();

// Page main
$tbayartitipansaldo_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbayartitipansaldo_edit->Page_Render();
?>
...
var CurrentForm = ftbayartitipansaldoedit = new ew_Form("ftbayartitipansaldoedit", "edit");

// Validate form
ftbayartitipansaldoedit.Validate = function() {
...
ftbayartitipansaldoedit.Form_CustomValidate = 
...
ftbayartitipansaldoedit.ValidateRequired = true;
<?php } else { ?>
ftbayartitipansaldoedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$tbayartitipansaldo_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $tbayartitipansaldo_edit->ShowPageHeader(); ?>
<?php
$tbayartitipansaldo_edit->ShowMessage();
?>
<form name="ftbayartitipansaldoedit" id="ftbayartitipansaldoedit" class="<?php echo $tbayartitipansaldo_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tbayartitipansaldo_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tbayartitipansaldo_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $tbayartitipansaldo->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tbayartitipansaldo" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($tbayartitipansaldo->id->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $tbayartitipansaldo->nomor->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tbayartitipansaldo" data-field="x_nomor" name="x_nomor" id="x_nomor" value="<?php echo ew_HtmlEncode($tbayartitipansaldo->nomor->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tbayartitipansaldo_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ftbayartitipansaldoedit.Init();
</script>
<?php
$tbayartitipansaldo_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbayartitipansaldo_edit->Page_Terminate();
?>
