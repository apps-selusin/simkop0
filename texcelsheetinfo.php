...
//
// Table class for texcelsheet
//
class ctexcelsheet extends cTable {
	var $SHEET;
	...
	function __construct() {
		...
		$this->TableVar = 'texcelsheet';
		$this->TableName = 'texcelsheet';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`texcelsheet`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// SHEET
		$this->SHEET = new cField('texcelsheet', 'texcelsheet', 'x_SHEET', 'SHEET', '`SHEET`', '`SHEET`', 200, -1, FALSE, '`SHEET`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`texcelsheet`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("texcelsheetview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("texcelsheetview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "texcelsheetadd.php?" . $this->UrlParm($parm);
		else
			$url = "texcelsheetadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("texcelsheetedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("texcelsheetadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("texcelsheetdelete.php", $this->UrlParm());
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			if ($isPost && isset($_POST["SHEET"]))
				$arKeys[] = ew_StripSlashes($_POST["SHEET"]);
			elseif (isset($_GET["SHEET"]))
				$arKeys[] = ew_StripSlashes($_GET["SHEET"]);
			else
