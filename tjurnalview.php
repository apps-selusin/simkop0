...
$tjurnal_view = NULL; // Initialize page object first

class ctjurnal_view extends ctjurnal {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "tjurnallist.php"; // Return to list
			}
			if (@$_GET["nomor"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tjurnallist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "tjurnallist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tjurnal_view)) $tjurnal_view = new ctjurnal_view();

// Page init
$tjurnal_view->Page_Init();

// Page main
$tjurnal_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tjurnal_view->Page_Render();
?>
...
var CurrentForm = ftjurnalview = new ew_Form("ftjurnalview", "view");

// Form_CustomValidate event
ftjurnalview.Form_CustomValidate = 
...
ftjurnalview.ValidateRequired = true;
<?php } else { ?>
ftjurnalview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftjurnalview.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftjurnalview.Lists["x_active"].Options = <?php echo json_encode($tjurnal->active->Options()) ?>;
...
<div class="ewToolbar">
<?php if (!$tjurnal_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $tjurnal_view->ExportOptions->Render("body") ?>
<?php
	foreach ($tjurnal_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$tjurnal_view->IsModal) { ?>
...
<?php $tjurnal_view->ShowPageHeader(); ?>
<?php
$tjurnal_view->ShowMessage();
?>
<form name="ftjurnalview" id="ftjurnalview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tjurnal_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tjurnal_view->Token ?>">
<?php } ?>
...
<?php if ($tjurnal->tanggal->Visible) { // tanggal ?>
	<tr id="r_tanggal">
		<td><span id="elh_tjurnal_tanggal"><?php echo $tjurnal->tanggal->FldCaption() ?></span></td>
...
<?php echo $tjurnal->tanggal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->periode->Visible) { // periode ?>
	<tr id="r_periode">
		<td><span id="elh_tjurnal_periode"><?php echo $tjurnal->periode->FldCaption() ?></span></td>
...
<?php echo $tjurnal->periode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($tjurnal->nomor->Visible) { // nomor ?>
	<tr id="r_nomor">
		<td><span id="elh_tjurnal_nomor"><?php echo $tjurnal->nomor->FldCaption() ?></span></td>
...
<?php echo $tjurnal->nomor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->transaksi->Visible) { // transaksi ?>
	<tr id="r_transaksi">
		<td><span id="elh_tjurnal_transaksi"><?php echo $tjurnal->transaksi->FldCaption() ?></span></td>
...
<?php echo $tjurnal->transaksi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->referensi->Visible) { // referensi ?>
	<tr id="r_referensi">
		<td><span id="elh_tjurnal_referensi"><?php echo $tjurnal->referensi->FldCaption() ?></span></td>
...
<?php echo $tjurnal->referensi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->model->Visible) { // model ?>
	<tr id="r_model">
		<td><span id="elh_tjurnal_model"><?php echo $tjurnal->model->FldCaption() ?></span></td>
...
<?php echo $tjurnal->model->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->rekening->Visible) { // rekening ?>
	<tr id="r_rekening">
		<td><span id="elh_tjurnal_rekening"><?php echo $tjurnal->rekening->FldCaption() ?></span></td>
...
<?php echo $tjurnal->rekening->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($tjurnal->posisi->Visible) { // posisi ?>
	<tr id="r_posisi">
		<td><span id="elh_tjurnal_posisi"><?php echo $tjurnal->posisi->FldCaption() ?></span></td>
...
<?php echo $tjurnal->posisi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->laporan->Visible) { // laporan ?>
	<tr id="r_laporan">
		<td><span id="elh_tjurnal_laporan"><?php echo $tjurnal->laporan->FldCaption() ?></span></td>
...
<?php echo $tjurnal->laporan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->debet->Visible) { // debet ?>
	<tr id="r_debet">
		<td><span id="elh_tjurnal_debet"><?php echo $tjurnal->debet->FldCaption() ?></span></td>
...
<?php echo $tjurnal->debet->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->credit->Visible) { // credit ?>
	<tr id="r_credit">
		<td><span id="elh_tjurnal_credit"><?php echo $tjurnal->credit->FldCaption() ?></span></td>
...
<?php echo $tjurnal->credit->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->kantor->Visible) { // kantor ?>
	<tr id="r_kantor">
		<td><span id="elh_tjurnal_kantor"><?php echo $tjurnal->kantor->FldCaption() ?></span></td>
...
<?php echo $tjurnal->kantor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->keterangan->Visible) { // keterangan ?>
	<tr id="r_keterangan">
		<td><span id="elh_tjurnal_keterangan"><?php echo $tjurnal->keterangan->FldCaption() ?></span></td>
...
<?php echo $tjurnal->keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->active->Visible) { // active ?>
	<tr id="r_active">
		<td><span id="elh_tjurnal_active"><?php echo $tjurnal->active->FldCaption() ?></span></td>
...
<?php echo $tjurnal->active->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($tjurnal->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_tjurnal_status"><?php echo $tjurnal->status->FldCaption() ?></span></td>
...
<?php echo $tjurnal->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($tjurnal->created->Visible) { // created ?>
	<tr id="r_created">
		<td><span id="elh_tjurnal_created"><?php echo $tjurnal->created->FldCaption() ?></span></td>
...
<?php echo $tjurnal->created->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tjurnal->modified->Visible) { // modified ?>
	<tr id="r_modified">
		<td><span id="elh_tjurnal_modified"><?php echo $tjurnal->modified->FldCaption() ?></span></td>
...
<?php echo $tjurnal->modified->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
