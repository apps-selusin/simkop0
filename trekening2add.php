...
$trekening2_add = NULL; // Initialize page object first

class ctrekening2_add extends ctrekening2 {
	...
	// Page object name
	var $PageObjName = 'trekening2_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "trekening2view.php")
	...
	function LoadDefaultValues() {
		...
		$this->parent1->CurrentValue = NULL;
		$this->parent1->OldValue = $this->parent1->CurrentValue;
		...
		$this->parent2->CurrentValue = NULL;
		$this->parent2->OldValue = $this->parent2->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// parent1
		$this->parent1->SetDbValueDef($rsnew, $this->parent1->CurrentValue, NULL, FALSE);
		...
		// parent2
		$this->parent2->SetDbValueDef($rsnew, $this->parent2->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($trekening2_add)) $trekening2_add = new ctrekening2_add();

// Page init
$trekening2_add->Page_Init();

// Page main
$trekening2_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$trekening2_add->Page_Render();
?>
...
var CurrentForm = ftrekening2add = new ew_Form("ftrekening2add", "add");

// Validate form
ftrekening2add.Validate = function() {
...
ftrekening2add.Form_CustomValidate = 
...
ftrekening2add.ValidateRequired = true;
<?php } else { ?>
ftrekening2add.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftrekening2add.Lists["x_group"] = {"LinkField":"x_group","Ajax":true,"AutoFill":false,"DisplayFields":["x_rekening","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"trekening2"};
ftrekening2add.Lists["x_parent1"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_rekening","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"trekening2"};
ftrekening2add.Lists["x_parent2"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_rekening","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"trekening2"};
ftrekening2add.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftrekening2add.Lists["x_active"].Options = <?php echo json_encode($trekening2->active->Options()) ?>;
...
<?php } ?>
<?php $trekening2_add->ShowPageHeader(); ?>
<?php
$trekening2_add->ShowMessage();
?>
<form name="ftrekening2add" id="ftrekening2add" class="<?php echo $trekening2_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($trekening2_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $trekening2_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ftrekening2add.CreateAutoSuggest({"id":"x_group","forceSelect":false});
</script>
</span>
...
<script type="text/javascript">
ftrekening2add.CreateAutoSuggest({"id":"x_parent1","forceSelect":false});
</script>
</span>
...
<script type="text/javascript">
ftrekening2add.CreateAutoSuggest({"id":"x_parent2","forceSelect":false});
</script>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $trekening2_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
