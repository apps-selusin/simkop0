...
class cvrekening2_add extends cvrekening2 {
	...
	function AddRow($rsold = NULL) {
		...
		// id1
		$this->id1->SetDbValueDef($rsnew, $this->id1->CurrentValue, "", FALSE);

		// id2
		$this->id2->SetDbValueDef($rsnew, $this->id2->CurrentValue, "", FALSE);
...
fvrekening2add.Lists["x_parent"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_rekening","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"trekening"};
fvrekening2add.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fvrekening2add.Lists["x_active"].Options = <?php echo json_encode($vrekening2->active->Options()) ?>;
...
<input type="text" data-table="vrekening2" data-field="x_id" name="x_id" id="x_id" size="30" maxlength="35" placeholder="<?php echo ew_HtmlEncode($vrekening2->id->getPlaceHolder()) ?>" value="<?php echo $vrekening2->id->EditValue ?>"<?php echo $vrekening2->id->EditAttributes() ?>>
</span>
